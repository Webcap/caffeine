...
//   Focusable({Key key, this.child, this.onFocus, this.onBlur, this.debugLabel})
//       : super(key: key);
...
//     _FocusableInherited _focusableInherited =
//         context.inheritFromWidgetOfExactType(_FocusableInherited);
...
//             duration: Duration(milliseconds: 500), alignment: 0);
...
//     renderBox.hitTest(result,
//         position: Offset(context.size.width / 2, context.size.height / 2));
...
//   void initState() {
//     focusNode =
//         FocusNode(debugLabel: 'Focusable Focus Node', onKey: _handleKey);
...
//     return _FocusableInherited(focusNode: focusNode, child: widget.child);
//   }
// }
