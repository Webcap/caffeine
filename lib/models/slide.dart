...
class Slide {
  ...
  factory Slide.fromJson(Map<String, dynamic> parsedJson) {
    return Slide(
      ...
      poster: (parsedJson['poster'] != null)
          ? Poster.fromJson(parsedJson['poster'])
          : null,
      genre: (parsedJson['genre'] != null)
          ? Genre.fromJson(parsedJson['genre'])
          : null,
      channel: (parsedJson['channel'] != null)
          ? Channel.fromJson(parsedJson['channel'])
          : null,
