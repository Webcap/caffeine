...
class Poster {
  ...
  factory Poster.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return Poster(
        ...
        imdb: (parsedJson['imdb'] == null || parsedJson['imdb'] == 0)
            ? 0
            : parsedJson['imdb'] * 1.00,
        ...
        classification: (parsedJson['classification'] == null)
            ? ""
            : parsedJson['classification'],
        year: parsedJson['year'],
        duration: parsedJson['duration'],
        rating: (parsedJson['rating'] == null || parsedJson['rating'] == 0)
            ? 0
            : parsedJson['rating'] * 1.00,
        image: parsedJson['image'],
        cover: (parsedJson['cover'] == null) ? "" : parsedJson['cover'],
        trailer: (parsedJson['trailer'] != null)
            ? Source.fromJson(parsedJson['trailer'])
            : null,
        sources: _sources,
        genres: _genres);
  }
